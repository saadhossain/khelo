function CMain(oData) {
    ...
    this._initSounds = function () {
        ...
        if (navigator.userAgent.indexOf("Opera") > 0 || navigator.userAgent.indexOf("OPR") > 0) {
            ...
            createjs.Sound.registerSound("./sounds/ball_collision.ogg", "boing");
            createjs.Sound.registerSound("./sounds/ball_lose.ogg", "ball_lose");
            createjs.Sound.registerSound("./sounds/fireball.ogg", "fireball");

            createjs.Sound.registerSound("./sounds/brick_crack.ogg", "brick_crack");
            createjs.Sound.registerSound("./sounds/brick_explosion.ogg", "brick_explosion");
            createjs.Sound.registerSound("./sounds/brick_metal_collision.ogg", "brick_metal");

            createjs.Sound.registerSound("./sounds/power_up_bonus.ogg", "power_up_bonus");
            createjs.Sound.registerSound("./sounds/power_up_malus.ogg", "power_up_malus");
            createjs.Sound.registerSound("./sounds/stage_clear.ogg", "stage_clear");

            createjs.Sound.registerSound("./sounds/bullet.ogg", "bullet");
            ...
            createjs.Sound.registerSound("./sounds/ball_collision.mp3", "boing");
            createjs.Sound.registerSound("./sounds/ball_lose.mp3", "ball_lose");
            createjs.Sound.registerSound("./sounds/fireball.mp3", "fireball");

            createjs.Sound.registerSound("./sounds/brick_crack.mp3", "brick_crack");
            createjs.Sound.registerSound("./sounds/brick_explosion.mp3", "brick_explosion");
            createjs.Sound.registerSound("./sounds/brick_metal_collision.mp3", "brick_metal");

            createjs.Sound.registerSound("./sounds/power_up_bonus.mp3", "power_up_bonus");
            createjs.Sound.registerSound("./sounds/power_up_malus.mp3", "power_up_malus");
            createjs.Sound.registerSound("./sounds/stage_clear.mp3", "stage_clear");

            createjs.Sound.registerSound("./sounds/bullet.mp3", "bullet");
