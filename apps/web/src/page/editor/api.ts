...
export async function getDesignById({ id, authToken }:{id:number; authToken:string}) {
  // if (id === 'local') {
  if (true) {
...
export async function listDesigns({ accessToken }:{accessToken:string}) {
...
export async function getUserSubscription({ accessToken }:{accessToken:string}) {
...
export async function cancelUserSubscription({ accessToken, id }:{id:number; accessToken:string}) {
...
export async function deleteDesign({ id, authToken }:{id:number; authToken:string}) {
